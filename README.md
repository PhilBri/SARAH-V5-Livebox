...
#### :arrow_right: La valeur *`plugin`* est toujours présente dans le retour.
...
#### :arrow_right: Les valeurs *`stby`*, *`cmd`* et *`epg`* sont présentes dans le retour suivant les cas et les commandes à envoyer à la livebox.
